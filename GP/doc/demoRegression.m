...
disp('Wait 10s, then continue...'); pause(1)
...
disp(' '); disp('Wait 10s, then continue...'); pause(1)
...
hold on; plot(z, m, 'LineWidth', 2); 
% plot(x, y, '+', 'MarkerSize', 12)
axis([-1.9 1.9 -0.9 3.9])
grid on
xlabel('input, x', Interpreter='latex',FontSize=15)
ylabel('output, y', Interpreter='latex',FontSize=15)
...
plot(q,w);
disp(' ')
title('Gaussian Process Prediction', Interpreter='latex',FontSize=15);
